  ...
  return (
    <>
      ...
      <div className='flex min-h-[calc(100vh-256px)] justify-center items-center flex-col'>
        ...
        <p className='md:w-3/5 text-center mt-2'>You will be able to Save your favourite resouces in your device, And you can access then anytime anywhere you want.</p>
