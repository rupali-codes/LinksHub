...
const Search = () => {
  ...
  return (
    <>
      ...
      <TopBar className="shadow-black-500/50 fixed top-[76px] z-30 flex w-full -translate-x-4 items-center bg-[--secondary-10] px-4 pt-6 pb-4 shadow-xl dark:bg-[--secondary-200] md:hidden" />
