      ...
      <div className="flex items-center gap-6">
        <li>
          <a
            ...
            className="dark:text-light-primary text-secondary-100"
            target="_blank"
          ...
          >
            ...
            >
              <FaDiscord className="hover:text-primary-60 transition duration-300 ease-in-out" />
            </IconContext.Provider>
          </a>
        </li>
        <li>
          ...
          >
            <IconContext.Provider
              value={{ className: 'shared-class', size: '24' }}
            >
              <FaGithub className="hover:text-primary-60 transition duration-300 ease-in-out" />
            </IconContext.Provider>
          </a>
        </li>
        <li>
          ...
          >
            <IconContext.Provider
              value={{ className: 'shared-class', size: '24' }}
            >
              <FaTwitter className="hover:text-primary-60 transition duration-300 ease-in-out" />
            </IconContext.Provider>
          </a>
        </li>
      </div>
