...
const Cards = () => {
  ...
  return (
    <div
      className={`flex flex-wrap md:flex-row w-full md:justify-start gap-4 content-start lg:min-h-[calc(90vh-99px)] min-h-[calc(90vh-150px)] mb-[0.29rem] md:-mb-[1.7rem] ${
