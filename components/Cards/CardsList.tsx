...
const CardsList: FC<{ cards: IData[] }> = ({ cards }) => {
  ...
  return (
    <>
      <ul className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 justify-items-stretch border-dark-silver border-2 border-opacity-75 shadow-lg shadow-silver">
