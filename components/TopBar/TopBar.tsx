...
export const TopBar = ({ header }: { header?: string }) => {
  ...
  return (
    <div className="sticky top-0 dark:bg-[#101623] bg-gray-100 w-full xs:overflow-x-hidden mb-4 flex flex-col-reverse items-center md:flex-row md:justify-between md:py-4">
