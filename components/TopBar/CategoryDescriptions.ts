...
const categoryDescriptions: CategoryDescriptions = {
  ...
  //backend
  api:
    "Interfaces that allow different software applications to communicate and share data with one another.",
  architecture:
  ...
  ruby:
    "Ruby is a high-level, interpreted programming language that was developed in the mid-1990s by Yukihiro Matsumoto in Japan. Ruby is widely used for developing web applications, mobile applications, and desktop applications.",
  typescript:
  ...
  technews:
    "Tech News is a great way to stay updated with the latest tech news.",
  ...
  css:
    "Cascading Style Sheets (CSS) is a style sheet language used for describing the presentation of a document written in a markup language such as HTML or XML. CSS is designed to enable the separation of content and presentation, including layout, colors, and fonts ",
  "data structures":
  ...
  git:
    "Your friendly neighborhood version control system to track the development activities.",
  "other-resources":
  ...
  //cloud computing
  aws:
    "AWS, Amazon's cloud computing platform, provides scalable and reliable services, including computing power, storage, and machine learning. Trusted by millions, AWS enables businesses to innovate and transform digitally with efficiency.",
  gcp:
    "Google Cloud is a prominent cloud computing platform offering a range of services, from computing and storage to advanced AI solutions. Trusted by businesses, it facilitates innovation and scalability.",
  azure:
  ...
  ibm:
    "IBM Cloud stands as a formidable cloud computing platform, offering a wide array of services. From computing power to advanced technologies, IBM Cloud supports businesses in their digital transformation journey.",
