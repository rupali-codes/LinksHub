...
const categoryDescriptions: CategoryDescriptions = {
  ...
  contributors:  'These are the people that have helped LinksHub come to life! Thank you for your support! Note: M = Maintainer C= Contributors'
}
