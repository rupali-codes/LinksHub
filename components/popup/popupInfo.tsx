        ...
        >
          ...
          <div className="card-actions justify-end mt-auto">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-2 px-6 py-2 text-white text-center bg-theme-secondary rounded-2xl w-full hover:bg-transparent hover:text-theme-secondary border border-dashed border-transparent duration-100 hover:border-theme-primary  bottom-0 flex items-center justify-center relative"
            >
              Visit site
            </a>
          </div>
