...
export const LinkContainer = ({ name, description, url, id }) => {
  ...
  return (
    <Link href={`${pathname}/${id}`}>
      <div className="transition-all ease-in duration-100 w-full cursor-pointer md:w-72 h-64 bg-white shadow-sm hover:shadow-purple-600 shadow- border hover:scale-[1.02] hover:border-solid border-dashed border-violet-500 rounded-3xl dark:bg-gray-900 dark:text-gray-300">
