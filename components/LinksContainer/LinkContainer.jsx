...
export const LinkContainer = ({ name, description, url }) => {
  return (
    <div className="transition-all duration-300 w-full md:w-72 h-64 bg-white shadow-xl border border-dashed border-violet-500 rounded-3xl dark:bg-gray-900 dark:text-gray-300">
