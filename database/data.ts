...
export const sidebarData: ISidebar[] = [
...

  {
    ...
    subcategory: [
      ...
      { name: 'Alibaba cloud', url: '/alibaba', resources: DB.alibaba },
      { name: 'Strapi cloud', url: '/strapi', resources: DB.strapi },
      { name: 'F5 cloud', url: '/f5', resources: DB.f5 },
      { name: 'Cloud docs', url: '/clouddocs', resources: DB.clouddocs },
      { name: 'Grafana cloud', url: '/grafana', resources: DB.grafana },
      { name: 'Spring cloud', url: '/spring', resources: DB.spring },
      { name: 'Intel cloud', url: '/intel', resources: DB.intel },
      { name: 'Redis cloud', url: '/redis', resources: DB.redis },
      { name: 'Meta cloud', url: '/meta', resources: DB.meta },
      { name: 'VMWare cloud', url: '/vmware', resources: DB.vmware },
    ],
  },
  {
