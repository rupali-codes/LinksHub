...
//cloud computing
export { default as googleCloud } from './cloud_computing_platforms/google-cloud.json'
export { default as awsCloud } from './cloud_computing_platforms/aws-cloud.json'
export { default as microsoftCloud } from './cloud_computing_platforms/microsoft-cloud.json'
export { default as oracleCloud } from './cloud_computing_platforms/oracle-cloud.json'
export { default as ibmCloud } from './cloud_computing_platforms/ibm-cloud.json'
//cyber_security
export { default as offensiveSecurity } from './cybersecurity/offensive-security.json'
export { default as defensiveSecurity } from './cybersecurity/defensive-security.json'
export { default as malwareAnalysis } from './cybersecurity/malware-analysis.json'
export { default as webSecurity } from './cybersecurity/web-application-security.json'
...
export { default as naturalLanguageProcessing } from './artificial_intelligence/natural-language-processing.json'
// Open-source
